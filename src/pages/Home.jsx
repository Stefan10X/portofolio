          ...
          <div className="flex flex-col gap-16 justify-center items-center ">
            ...
            <div className="flex flex-col gap-6 text-xl xl:text-3xl text-gray-500 ">
              <Reveal>
                ...
                >
                  I'm a final year student pursuing Economic Informatics at
                  Transilvania University of Brașov. I live in Ianca, Brăila,
                  România. Since I was a kid I had a passion for design, that's
                  why I chose to focus on Front-End development. <br />I am very
                  eager to improve my coding skills by developing websites and
                  applications.
                </p>
              </Reveal>
              <Reveal>
              ...
              <Reveal>
                <div className="mt-6 flex justify-center items-center">
                  <button
                    onClick={() =>
                      window.open(
                        "https://drive.google.com/file/d/1fOcICAIXtI-kj6m2G1jWDaQv3ozTkoEN/view?usp=sharing",
                        "_blank"
                      )
                    }
